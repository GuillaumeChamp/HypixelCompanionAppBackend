...
public class DatabaseHealthIndicator implements HealthIndicator {
    ...
    public Health health() {
        ...
        List<ItemPricing> lastEntries = itemPricingRepository.findAllByItemIdAndTimestampBetweenOrderByTimestamp(TEST_ITEM_ID, LocalDateTime.now().minusMinutes(3), LocalDateTime.now());
